...
The `data` folder contains five folders (`0`, `1`, `2`, `3`, `4`) previously tagged by a Biology Team, indicating the severity of the Coffee Leaf Rust development stage. This corresponds to the following figure:
